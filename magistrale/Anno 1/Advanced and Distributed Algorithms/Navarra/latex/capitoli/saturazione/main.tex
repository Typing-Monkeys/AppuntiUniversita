...
%Permetterà di trovare esattamente $2$ iniziatori vicini tra loro ed assume come
...
%diventato SATURATED perchè ha ricevuto un messaggio M dal suo parent $s_2$;
%poichè s2 ha inviato un messaggio M ad s1, s2 deve essere stato in PROCESSING
        ...
        \item \textbf{Dimostro che esattamente due nodi diventano Saturated:}
              \begin{enumerate}
                  ...
                  \item Quando M inviato da $x$ arriva ad $s_1$, questo lo invia a suo
                        ...
                        quindi diventa SATURATED.% tramite $s_1$ diventerà per forza anche
                        lui SATURATED.
              \end{enumerate}
...
%Nell'algoritmo tutte le entità partono dallo stato di Avaiable (che è lo stesso
