...
Tutti i precedenti protocolli funzionano \underline{solo} sotto le restrizioni IR,
...
\begin{center}
    ...
    \TODO[inline]{ricontrollare. dovrebbe essere 2n+k-2}
...
%\end{itemize}
\begin{center}
    \includegraphics[scale=0.5]{capitoli/leader-election/imgs/controlled.png}
\end{center}
...
\begin{itemize}
    \item \textbf{AVAILABLE:} Se ricevi impulso spontaneo allora fissa lo stage =
          ...
          Capture a quest'ultimo allegando il tuo stage ed il tuo id. Successivamente
          diventa CANDIDATE.\\
...
\begin{itemize}
    ...
    \item $H_{n/2}$ è una la serie armonica
          crescente, che ha come risultato $nlogn$.
