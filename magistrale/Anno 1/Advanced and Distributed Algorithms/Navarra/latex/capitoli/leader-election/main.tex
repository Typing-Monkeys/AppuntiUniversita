...
\TODO[inline]{ricontrollare. Il primo dovrebbe essere n+k-2}
\begin{equation*}
    \begin{split}
...
\subsubsection{Sviluppo del protocollo}
\begin{enumerate}
...
\textbf{Quanti candidati possono essere presenti allo stage
    $i$?}\\
