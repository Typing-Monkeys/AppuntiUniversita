...
%%TODO: riguardare meglio che manca qualche pezzo
\paragraph{Esempio.}
...
\paragraph{Server Side: } si verifica quando i dati forniti
...
Per uno sviluppatore web, ci sono due modi diversi di eseguire la gestione sicura
degli input:
