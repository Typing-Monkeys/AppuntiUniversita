...
\input{santini/capitolo2_buff_over}
\input{santini/capitolo3_ROP}
\input{santini/capitolo4_heap}
\input{santini/capitolo5_Pointer_sub}
%%integer security
%%Fuzz test and Sanification
%%race conditions

\part{Etherium}

\part{Identity management in applications}
\input{santini/capitolo6_IDmanag}
