...
%% mannaggia a quel porco del signore, erano al contrario !!
%% guadare https://www.dmi.unipg.it/~bista/didattica/CSP/soft-csps.pdf [pagina 19]
\begin{itemize}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=10cm, keepaspectratio]{img/Cap5/divisione.png}
\end{figure}
