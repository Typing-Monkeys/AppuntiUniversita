...
l’\textit{ampiezza di banda} di $f$, che è misurata in cicli per unita di tempo (Hertz) e
...
e Shannon lo chiamò \textit{intervallo di Nyquist} corrispondente alla frequenza di
...
\begin{enumerate}
    \item \textit{Quanti campioni sono necessari per assicurare che l’informazione
          ...
          cioe $f_s \ge 2 f_H$ , dove $f_s$ è la frequenza sampling, $f_H$ è la piu alta
          ...
          Nella pratica il sovracampionamento deve essere effettuato molto spesso, poiché
...
Benché il teorema del campionamento venga largamente impiegato in ambito applicativo
...
\begin{itemize}
    \item Le ipotesi fatte sul segnare da ricostruire $f$, ovvero che sia ad energia finita
          ...
          estremamente regolari e ci consente di ricostruire solo segnali appartenenti alla classe
    ...
    \item Per il principio di Hisemberg i segnali non possono essere contemporaneamente
...
Poiché $f$ è limitata e il momento $m_0(\varphi) \leq +\infty$ risulta che
...
di immagini. Nell'ultimo caso, si utilizza l'algoritmo Sampling Kantorovich con
...
ricostruzione perché ha una minor perdita di informazione ed ha un indice
PSNR migliore.
