...
\TODO[inline]{Questa parte dovrebbe far parte del Chapter Elaborazione Immagini
    ed essere messa con le elaborazioni locali}
\subsection{ZOOM}
...
\TODO[inline]{Allinaeare immagine della campana alla formula!}
\begin{figure}
    \centering
    \includegraphics[width=4cm, keepaspectratio]{capitoli/immagini/imgs/campana.png}
\end{figure}
\begin{figure}[H]
    \centering
...
\TODO[inline]{L'idea di impaginazione è questa, sistemare!}
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=4cm, keepaspectratio]{capitoli/immagini/imgs/salepepe.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
...
\TODO[inline]{Allinare foto alla formula!}
\begin{figure}
    \centering
    \includegraphics[width=4cm, keepaspectratio]{capitoli/immagini/imgs/raley.png}
\end{figure}
...
\TODO[inline]{Allineare foto alla formula!}

\begin{figure}[H]
    \centering
    \includegraphics[width=4cm, keepaspectratio]{capitoli/immagini/imgs/gamma.png}
\end{figure}
...
\TODO[inline]{Allinare foto a formula!}
\begin{figure}[H]
    \centering
    \includegraphics[width=4cm, keepaspectratio]{capitoli/immagini/imgs/esponenziale.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm, keepaspectratio]{capitoli/immagini/imgs/roberts.png}
